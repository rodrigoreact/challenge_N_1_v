...
plt.title("Ventas por Categoría T1")
...
plt.title("Top 5 Productos Más Vendidos T1")
plt.ylabel("Cantidad de Ventas")
plt.tight_layout()
...
plt.title("Distribución de Calificaciones T1")
...
if "lat" in df.columns and "lon" in df.columns:
    ...
    plt.title("Distribución Geográfica de Ventas T1")
    plt.xlabel("Longitud")
    plt.ylabel("Latitud")
...
pdf.cell(0, 10, "Ventas por categoría T1:", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
